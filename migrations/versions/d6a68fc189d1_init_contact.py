...
Revision ID: 73d57b79747b
Revises:
Create Date: 2023-12-17 18:36:59.356666
...
def upgrade() -> None:
    ...
    sa.Column('updated_at', sa.DateTime(), nullable=True, default=None, onupdate=sa.func.now()),
